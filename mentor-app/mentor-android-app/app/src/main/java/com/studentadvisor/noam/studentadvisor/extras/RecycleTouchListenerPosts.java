 ...
 */
public class RecycleTouchListenerPosts implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private ClickListenerPosts clickListener;

    public RecycleTouchListenerPosts(Context context, final RecyclerView recyclerView, final int size,final boolean news_feed_bool, final ClickListenerPosts clickListener) {
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                ...
                if (recyclerView.getChildPosition(child) != itemCount) {
                    if (child != null) {
