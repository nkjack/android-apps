...
import com.studentadvisor.noam.studentadvisor.tasks.TaskAllLikesDegrees;
 ...
 */
public class MyLikesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyLikesFragment fragmentContext;
    ...
    public static MyLikesFragment newInstance(int tab_num) {
...
//        onRefresh();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRoot = (RelativeLayout) view.findViewById(R.id.myLikesFragmentRoot);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipeLikesRefresh);
        mSwipeRefreshLayout.setOnRefreshListener(this);
        recyclerView = (RecyclerView) view.findViewById(R.id.listAllLikes);
        recyclerView.addItemDecoration(new MarginDecoration(getActivity()));

        mProgressBar = (ProgressBar) view.findViewById(R.id.myLikesProgressBar);
...
//                        new TaskLikeDegree(getApplicationContext(), user_uid, name).execute(degree);
        ...
        if (savedInstanceState != null) {
        ...
        else if (mCommunicator != null && !mCommunicator.getListLikes().isEmpty()){
            mListDegrees = mCommunicator.getListLikes();
            rvAdapter.setDegrees(mListDegrees);
            ...
            if (user != null && user.isLoggedIn() && mDrawerLayoutCallback != null) {
                if (mCommunicator.CheckEnabledInternet()) {
                    new TaskAllLikesDegrees(mDrawerLayoutCallback, user.getUser_id()).execute();
                }
            } else {
